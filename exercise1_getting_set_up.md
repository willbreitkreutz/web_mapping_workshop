...
1. Accounts - In order to fully leverage the tools that are available to us we need to have accounts in two places, [GitHub](https://www.github.com) and [MapBox](https://www.mapbox.com).  Go ahead and sign up for those services, I'll wait.
